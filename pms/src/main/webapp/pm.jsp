...
<script type="text/javascript">
       ...
       function editNode(id) {
       	   window.location.href = "${pageContext.request.contextPath}/source/info/"+id;
       }
       
       //删除节点
       function deleteNode(id){
    	   layer.confirm("删除资源信息, 是否继续",  {icon: 2, title:'提示'}, function(cindex){
				// 删除选择的用户信息
				$.ajax({
					type : "POST",
